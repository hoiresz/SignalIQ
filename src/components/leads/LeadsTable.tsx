...
export const LeadsTable: React.FC<LeadsTableProps> = ({ leads, onExportCSV }) => {
      ...
      <div className="h-full flex items-center justify-center bg-white">
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 max-w-md mx-auto leading-relaxed">
            Start by asking me to find companies or people that match your criteria. 
            Try something like "Find SaaS companies that raised Series A funding in 2024"
          </p>
        </div>
      </div>
    );
